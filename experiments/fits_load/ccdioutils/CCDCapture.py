...
class CCDCapture:
    ...
    def __setInfo(
        ...
        self.__info = CCDCapture.Info(cols, rows, min, max, start, end, date)

    @staticmethod
    def __fromHDU(hdu: fits.hdu):
        dump = CCDCapture(hdu.data)
