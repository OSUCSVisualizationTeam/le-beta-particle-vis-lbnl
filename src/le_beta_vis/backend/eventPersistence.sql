...
BEGIN
    ...
    END;
    START TRANSACTION;
    INSERT INTO clusters(fitsFile, data, totalEnergy, sigmaX, sigmaY, classification, pixelCount)
    VALUES (fitsFile, data, totalEnergy, sigmaX, sigmaY, classification, pixelCount);
